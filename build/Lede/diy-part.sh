...
sed -i '/<tr><td width="33%"><%:CPU usage/a <tr><td width="33%"><%:Compiler author%></td><td><a target="_blank" href="https://github.com/shaufo/">【我的GitHub仓库】https://github.com/shaufo/</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
sed -i '/<tr><td width="33%"><%:Compiler author/a <tr><td width="33%"><%:Firmware Update%></td><td><a target="_blank" href="https://github.com/shaufo/OpenWrt_Build_x64_gxnas/releases/tag/Update-x86">点这里下载最新版本</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
# 后台IP设置
export Ipv4_ipaddr="192.168.1.9"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"          # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt-pang"               # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export Customized_Information="OpenWrt_x64_旁路由版 by Shaufo build $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
